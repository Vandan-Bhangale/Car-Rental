      ...
      >
        ...
        <div>
          ...
          <p className="mt-3 text-sm">
            Rent your car easily with affordable hourly & daily rentals. No
            hidden charges, just smooth rides!
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/cars" className="hover:text-red">
                Cars
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/faq" className="hover:text-red">
                FAQ
              </a>
            </li>
            <li>
